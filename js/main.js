...
async function loadProjects() {
  if (!SITE?.projects_file) return;
  try {
    // Load the pre-compiled projects file (generated by `node js/update_projects.js`)
    ...
    console.error('Failed to load compiled projects:', e);
  }
}
